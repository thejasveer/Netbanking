...
function  Appbar(){
  ...
  return <div className='flex gap-2 text-xl justify-center items-center shadow-md shadow-blue-400 p-4'>
    <div className='flex items-center'><span>W</span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
  <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21 3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />
    ...
    <div className='flex items-center rounded-md p-1 gap-1'><svg xmlns="http://www.w3.org/2000/svg" fill="bg-blue-100 " viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="bg-blue-300 p-0.5 animate-pulse  rounded-full size-6">
  <path strokeLinecap="round" strokeLinejoin="round" d="m21 7.5-2.25-1.313M21 7.5v2.25m0-2.25-2.25 1.313M3 7.5l2.25-1.313M3 7.5l2.25 1.313M3 7.5v2.25m9 3 2.25-1.313M12 12.75l-2.25-1.313M12 12.75V15m0 6.75 2.25-1.313M12 21.75V19.5m0 2.25-2.25-1.313m0-16.875L12 2.25l2.25 1.313M21 14.25v2.25l-2.25 1.313m-13.5 0L3 16.5v-2.25" />
</svg><span>Netbanking</span>
